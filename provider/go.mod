module github.com/MaienM/pulumi-gitea/provider
...
require (
	code.gitea.io/terraform-provider-gitea v0.3.0
...
replace code.gitea.io/terraform-provider-gitea => github.com/go-gitea/terraform-provider-gitea v0.3.0
